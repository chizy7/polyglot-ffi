...
class DuneGenerator:
    ...
    def _format_packages(self, ocaml_libraries: list[str] | None = None) -> str:
        """Format additional packages for ocamlfind -package flag."""
        if not ocaml_libraries:
            return ""
        return "," + ",".join(ocaml_libraries)

    def _get_library_link_flags(self, ocaml_libraries: list[str] | None = None) -> str:
    ...
    def generate_dune(self, module_name: str, ocaml_libraries: list[str] | None = None) -> str:
